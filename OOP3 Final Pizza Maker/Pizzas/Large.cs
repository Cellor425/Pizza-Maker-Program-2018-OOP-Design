...
{
    /// <summary>
    /// A large pizza object.
    /// </summary>
    public class Large : Pizza
    {
        /// <summary>
        /// Initializes a new instance of the Large class.
        /// </summary>
        ...
        {
            return this.CalculateCheese() + this.CalculateCrust() + this.CalculateMeat() + this.CalculateSauce() + 5.00m;
        }
